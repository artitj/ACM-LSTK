/*=========================================================================
  ...
  Module:    itkLesionSegmentationImageFilterELIC.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef itkLesionSegmentationImageFilterELIC_h
#define itkLesionSegmentationImageFilterELIC_h
...
/** \class LesionSegmentationImageFilterELIC
...
public:
  ...
  typedef LesionSegmentationImageFilterELIC                    Self;
  ...
  itkTypeMacro(LesionSegmentationImageFilterELIC, ImageToImageFilter);
...
protected:
  LesionSegmentationImageFilterELIC();
  LesionSegmentationImageFilterELIC(const Self&) {}
...
private:
  virtual ~LesionSegmentationImageFilterELIC(){};
...
#include "itkLesionSegmentationImageFilterELIC.hxx"
#endif
